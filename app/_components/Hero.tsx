            ...
            <div className="flex items-center justify-between gap-1 pt-5">
                <div className="flex space-x-4 gap-4 flex-col">
                    <div className="relative">
                        <div
                            className={cn(
                                "size-20 rounded-lg bg-linear-to-br flex items-center justify-center relative outline outline-offset-[3px] outline-border",
                                resolvedTheme === "dark"
                        ...
                        >
                            <Image
                                ...
                                aria-label="Profile photo of Sagar"
                                quality={100}
                            />
                        </div>
                    </div>
